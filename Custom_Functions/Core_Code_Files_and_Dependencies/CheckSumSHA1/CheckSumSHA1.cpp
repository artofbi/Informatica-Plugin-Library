...
static IUNICHAR *CheckSumSHA1_STR = (IUNICHAR *)L"CheckSumSHA1";
                                                ...
                                                INFA_EXPR_VALIDATE_METHODS* functions)
{
    ...
    functions->validateFunction = validateFunctionCheckSumSHA1;
    functions->getFunctionDescription = getDescriptionCheckSumSHA1;
    functions->getFunctionPrototype = getPrototypeCheckSumSHA1;
...
{    
    ...
    functions->module_init = moduleInitCheckSumSHA1;
    functions->module_deinit = moduleDeinitCheckSumSHA1;
...
{    
    functions->function_init = functionInitCheckSumSHA1;
    functions->function_deinit = functionDeinitCheckSumSHA1;
...
{    
    functions->fnInstance_init = functionInstInitCheckSumSHA1;
    functions->fnInstance_processRow = processRowCheckSumSHA1;
    functions->fnInstance_deinit = functionInstDeinitCheckSumSHA1;
...
extern "C" SAMPLE_EXPR_SPEC 
    IUNICHAR * getDescriptionCheckSumSHA1(IUNICHAR* ns, IUNICHAR* sFuncName)
{
    static IUNICHAR *uniDesc = (IUNICHAR *)L"Returns a string based on the SHA1-Algorithm after assessing all input arguments. Max 50 Arguments. Min 1 Argument.";
    return uniDesc;
}

// method to get prototype of function
extern "C" SAMPLE_EXPR_SPEC 
    IUNICHAR * getPrototypeCheckSumSHA1(IUNICHAR* ns, IUNICHAR* sFuncName)
{
    static IUNICHAR *uniProt = (IUNICHAR *)L"CheckSumSHA1(Arg1 [, Arg2, Arg3, Arg4, Arg50])";
...
extern "C" SAMPLE_EXPR_SPEC 
    INFA_EXPR_STATUS validateFunctionCheckSumSHA1(IUNICHAR* ns, IUNICHAR* sFuncName, 
                                        IUINT32 numArgs, 
                                        ...
                                        INFA_EXPR_OPD_METADATA* retValue)
{
    ...
    {
        IUNICHAR *errMsg = (IUNICHAR *)L"CheckSumSHA1 function takes 1 to 50 arguments";
...
extern "C" SAMPLE_EXPR_SPEC 
    INFA_EXPR_ROWSTATUS processRowCheckSumSHA1(INFA_EXPR_FUNCTION_INSTANCE_HANDLE *fnInstance, IUNICHAR **errMsg)
{
...
extern "C" SAMPLE_EXPR_SPEC 
    INFA_EXPR_STATUS moduleInitCheckSumSHA1(INFA_EXPR_MODULE_HANDLE *modHandle)
{
    INFA_EXPR_STATUS exprStatus;

    // initialize the CheckSumSHA1_STR
    exprStatus.status = ISUCCESS;
    return exprStatus;
}
...
extern "C" SAMPLE_EXPR_SPEC 
    INFA_EXPR_STATUS moduleDeinitCheckSumSHA1(INFA_EXPR_MODULE_HANDLE *modHandle)
{
    INFA_EXPR_STATUS exprStatus;
    exprStatus.status = ISUCCESS;
    return exprStatus;
...
extern "C" SAMPLE_EXPR_SPEC 
    INFA_EXPR_STATUS functionInitCheckSumSHA1(INFA_EXPR_FUNCTION_HANDLE *funHandle)
{
    INFA_EXPR_STATUS exprStatus;
    exprStatus.status = ISUCCESS;
    return exprStatus;
...
extern "C" SAMPLE_EXPR_SPEC 
    INFA_EXPR_STATUS functionDeinitCheckSumSHA1(INFA_EXPR_FUNCTION_HANDLE *funHandle)
{
    INFA_EXPR_STATUS exprStatus;
    exprStatus.status = ISUCCESS;
    return exprStatus;
...
extern "C" SAMPLE_EXPR_SPEC 
    INFA_EXPR_STATUS functionInstInitCheckSumSHA1(INFA_EXPR_FUNCTION_INSTANCE_HANDLE *funInstHandle)
{
	INFA_EXPR_STATUS exprStatus;
    exprStatus.status = ISUCCESS;
