#ifndef __IsValidEmailAddress_PLUGIN_HPP
#define __IsValidEmailAddress_PLUGIN_HPP
...
// method to get description of IsValidEmailAddress function
extern "C" SAMPLE_EXPR_SPEC IUNICHAR * getDescriptionIsValidEmailAddress(IUNICHAR* ns, IUNICHAR* sFuncName);

// method to get prototype of IsValidEmailAddress function
extern "C" SAMPLE_EXPR_SPEC IUNICHAR * getPrototypeIsValidEmailAddress(IUNICHAR* ns, IUNICHAR* sFuncName);

// method to validate usage of IsValidEmailAddress function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS validateFunctionIsValidEmailAddress(IUNICHAR* ns, IUNICHAR* sFuncName, 
...
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_ROWSTATUS processRowIsValidEmailAddress(INFA_EXPR_FUNCTION_INSTANCE_HANDLE *fnInstance, IUNICHAR **errMsg);

// method to do module level initialization for IsValidEmailAddress function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS moduleInitIsValidEmailAddress(INFA_EXPR_MODULE_HANDLE *modHandle);

// method to do module level deinitialization for IsValidEmailAddress function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS moduleDeinitIsValidEmailAddress(INFA_EXPR_MODULE_HANDLE *modHandle);

// method to do function level initialization for IsValidEmailAddress function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS functionInitIsValidEmailAddress(INFA_EXPR_FUNCTION_HANDLE *funHandle);

// method to do function level deinitialization for IsValidEmailAddress function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS functionDeinitIsValidEmailAddress(INFA_EXPR_FUNCTION_HANDLE *funHandle);

// method to do function instance level initialization for IsValidEmailAddress function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS functionInstInitIsValidEmailAddress(INFA_EXPR_FUNCTION_INSTANCE_HANDLE *funInstHandle);
