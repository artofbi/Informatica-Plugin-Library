...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk /export/home/infa/SunStudioWorkspace/Output_SOs/libConcatenate.so
...
${OBJECTDIR}/Concatenate.o: Concatenate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast +w -I/usr/include -I../../SunStudioWorkspace/_Libraries -KPIC  -o ${OBJECTDIR}/Concatenate.o Concatenate.cpp
