...
OUTPUT_PATH=dist/Debug/${PLATFORM}/libIsPalindrome.so
...
# Generate tar file
cd "${TOP}"
rm -f dist/Debug/${PLATFORM}/package/libIsPalindrome.so.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Debug/${PLATFORM}/package/libIsPalindrome.so.tar *
checkReturnCode
