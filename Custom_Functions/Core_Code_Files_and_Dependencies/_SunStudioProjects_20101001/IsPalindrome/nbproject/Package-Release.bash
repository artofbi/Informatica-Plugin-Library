...
OUTPUT_PATH=/export/home/infa/SunStudioWorkspace/Output_SOs/libIsPalindrome.so
...
# Generate tar file
cd "${TOP}"
rm -f dist/Release/${PLATFORM}/package/libIsPalindrome.so.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Release/${PLATFORM}/package/libIsPalindrome.so.tar *
checkReturnCode
