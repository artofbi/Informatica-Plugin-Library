...
OUTPUT_PATH=dist/Debug/${PLATFORM}/libIsValidEmailAddress.so
...
# Generate tar file
cd "${TOP}"
rm -f dist/Debug/${PLATFORM}/package/libIsValidEmailAddress.so.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Debug/${PLATFORM}/package/libIsValidEmailAddress.so.tar *
checkReturnCode
