...
OUTPUT_PATH=dist/Release_x64/${PLATFORM}/libIsValidEmailAddress.so
...
# Generate tar file
cd "${TOP}"
rm -f dist/Release_x64/${PLATFORM}/package/libIsValidEmailAddress.so.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Release_x64/${PLATFORM}/package/libIsValidEmailAddress.so.tar *
checkReturnCode
