#ifndef __URLEncodeDecode_PLUGIN_HPP
#define __URLEncodeDecode_PLUGIN_HPP
...
// method to get description of URLEncodeDecode function
extern "C" SAMPLE_EXPR_SPEC IUNICHAR * getDescriptionURLEncodeDecode(IUNICHAR* ns, IUNICHAR* sFuncName);

// method to get prototype of URLEncodeDecode function
extern "C" SAMPLE_EXPR_SPEC IUNICHAR * getPrototypeURLEncodeDecode(IUNICHAR* ns, IUNICHAR* sFuncName);

// method to validate usage of URLEncodeDecode function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS validateFunctionURLEncodeDecode(IUNICHAR* ns, IUNICHAR* sFuncName, 
...
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_ROWSTATUS processRowURLEncodeDecode(INFA_EXPR_FUNCTION_INSTANCE_HANDLE *fnInstance, IUNICHAR **errMsg);

// method to do module level initialization for URLEncodeDecode function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS moduleInitURLEncodeDecode(INFA_EXPR_MODULE_HANDLE *modHandle);

// method to do module level deinitialization for URLEncodeDecode function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS moduleDeinitURLEncodeDecode(INFA_EXPR_MODULE_HANDLE *modHandle);

// method to do function level initialization for URLEncodeDecode function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS functionInitURLEncodeDecode(INFA_EXPR_FUNCTION_HANDLE *funHandle);

// method to do function level deinitialization for URLEncodeDecode function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS functionDeinitURLEncodeDecode(INFA_EXPR_FUNCTION_HANDLE *funHandle);

// method to do function instance level initialization for URLEncodeDecode function
extern "C" SAMPLE_EXPR_SPEC INFA_EXPR_STATUS functionInstInitURLEncodeDecode(INFA_EXPR_FUNCTION_INSTANCE_HANDLE *funInstHandle);
